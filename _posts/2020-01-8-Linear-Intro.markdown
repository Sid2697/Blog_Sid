...
As this linear program is in two-dimensional space, we can visualise it easily and get a idea of it. Plotting the constrtaint ![c3](http://latex.codecogs.com/svg.latex?2x_1+x_2\leq6) (which is a line in two-dimensional space) we get
